#!/bin/bash
#  -m /models/Qwen3.6-27B-GGUF/Qwen3.6-27B-UD-Q6_K_XL.gguf \
...
# models/bartowski/Qwen3.6-27B-GGUF/Qwen_Qwen3.6-27B-Q8_0.gguf models/bartowski/Qwen3.6-27B-GGUF/mmproj-Qwen_Qwen3.6-27B-bf16.gguf

#  -m /models/Qwen3.6-WebAgent/Qwen3.6-9B-UD-Q4_K_XL.gguf \
#  --mmproj /models/Qwen3.6-WebAgent/mmproj-F16.gguf \
